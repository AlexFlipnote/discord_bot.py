...
class Encryption(commands.Cog):
    ...
    async def encryptout(self, interaction: discord.Interaction[DiscordBot], convert: str, _input: Union[bytes, str]) -> None:
        ...
        if len(_input) > 1900:
            ...
            try:
                ...
                if err.code == 50045:
                    return await interaction.followup.send(f"The file I returned was too big, sorry {interaction.user.name}...")
    ...
    async def encode_base32(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Encode in base32 """
        _input = await self.handle_input(text, text_file)
        await self.encryptout(
            interaction, "Text -> base32", base64.b32encode(_input.encode("utf-8"))
        )

    @decode.command(name="base32")
    async def decode_base32(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Decode in base32 """
        _input = await self.handle_input(text, text_file)
        try:
    ...
    async def encode_base64(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Encode in base64 """
        _input = await self.handle_input(text, text_file)
        await self.encryptout(
            interaction, "Text -> base64", base64.urlsafe_b64encode(_input.encode("utf-8"))
        )

    @decode.command(name="base64")
    async def decode_base64(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Decode in base64 """
        _input = await self.handle_input(text, text_file)
        try:
    ...
    async def encode_rot13(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Encode in rot13 """
        _input = await self.handle_input(text, text_file)
        await self.encryptout(
            interaction, "Text -> rot13", codecs.decode(_input, "rot_13")
        )

    @decode.command(name="rot13")
    async def decode_rot13(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Decode in rot13 """
        _input = await self.handle_input(text, text_file)
        try:
    ...
    async def encode_hex(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Encode in hex """
        _input = await self.handle_input(text, text_file)
        await self.encryptout(
            interaction, "Text -> hex", binascii.hexlify(_input.encode("utf-8"))
        )

    @decode.command(name="hex")
    async def decode_hex(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Decode in hex """
        _input = await self.handle_input(text, text_file)
        try:
    ...
    async def encode_base85(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Encode in base85 """
        _input = await self.handle_input(text, text_file)
        await self.encryptout(
            interaction, "Text -> base85", base64.b85encode(_input.encode("utf-8"))
        )

    @decode.command(name="base85")
    async def decode_base85(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Decode in base85 """
        _input = await self.handle_input(text, text_file)
        try:
    ...
    async def encode_ascii85(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Encode in ASCII85 """
        _input = await self.handle_input(text, text_file)
        await self.encryptout(
            interaction, "Text -> ASCII85", base64.a85encode(_input.encode("utf-8"))
        )

    @decode.command(name="ascii85")
    async def decode_ascii85(self, interaction: discord.Interaction[DiscordBot], text: Optional[str], text_file: Optional[discord.Attachment] = None):
        """ Decode in ASCII85 """
        _input = await self.handle_input(text, text_file)
        try:
